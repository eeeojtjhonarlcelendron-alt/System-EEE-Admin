-- Update the sync_cluster_to_kpi function to use an unlimited timeout for large hub updates
-- This fixes statement timeouts by allowing the server-side update to complete.
